class City {
  ...
  static List<City> allCities()
  {
    ...
    lstOfCities.add(new City(name:"Lahore",country: "Pakistan",population: "10 mill",image: "lahore.png"));
    ...
    lstOfCities.add(new City(name:"Lahore",country: "Pakistan",population: "19 mill",image: "lahore.png"));
